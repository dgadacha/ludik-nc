...
{block name='step_content'}
  ...
  <div class="payment-options__list{if $is_free} d-block d-sm-none{/if}">
    {foreach from=$payment_options item="module_options"}
      ...
      {/foreach}
    {foreachelse}
      <p class="alert alert-danger">Aucun moyen de paiement n'est disponible pour cette commande.</p>
    {/foreach}
  </div>
    ...
    <div id="payment-confirmation" class="js-payment-confirmation">
      ...
      <div class="ps-hidden-by-js">
        {if $selected_payment_option and $all_conditions_approved}
          <label for="pay-with-{$selected_payment_option}">Commander avec obligation de paiement</label>
        {/if}
      </div>
    </div>
  </div>
